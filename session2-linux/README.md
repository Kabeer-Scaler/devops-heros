...
![Task 3 System Logs](screenshots/task3-journalctl-1.png)

### View logs for a specific service

![Task 3 Service Logs](screenshots/task3-journalctl-2.png)


## Task 4: Linux Command Cheat Sheet

Practiced networking commands from the provided Linux `ip` command cheat sheet, including `ip addr`, `ip link`, `ip route`, `ip neigh`, and `ss`.
